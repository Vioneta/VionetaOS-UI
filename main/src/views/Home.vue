	...
	methods: {
		...
		rssConfirm() {
			this.$buefy.dialog.confirm({
				title: this.$t('Show news feed from VionetaOS Blog'),
				message: this.$t('VionetaOS dashboard will get the the latest news feed of https://blog.vioneta.com via Internet, which might leave your visit records to the site. Do you accept?'),
				type: 'is-dark',
