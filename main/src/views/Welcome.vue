		...
		<div v-if="!isLoading" v-animate-css="initAni" :class="'step' + step" class="login-panel is-shadow">
			...
			<div v-if="step == 2">
				...
				<div class="is-flex is-justify-content-center">
					<div class="has-text-centered">
						<b-image
							:src="require('@/assets/img/account/default-avatar.svg')"
							class="is-128x128"
							rounded
						></b-image>
					</div>
					...
					<ValidationProvider v-slot="{ errors, valid }" name="User" rules="required">
						...
						>
							<b-input
								v-model="username"
								type="text"
								v-on:keyup.enter.native="handleSubmit(register)"
							></b-input>
						</b-field>
					</ValidationProvider>
					<ValidationProvider
			...
			<div v-if="step == 3" class="has-text-centered">
				...
				<div class="is-flex is-align-items-center is-justify-content-center">
					<lottie-animation
						:animationData="require('@/assets/ani/done.json')"
						:autoPlay="true"
						:loop="false"
						class="animation"
						@complete="complete"
...
export default {
	...
	methods: {
		...
		register() {
			...
			this.$api.users
				.register(this.username, this.password, initKey)
				.then((res) => {
