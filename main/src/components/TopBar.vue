	...
	methods: {
		...
		rssConfirm() {
			...
			this.$buefy.dialog.confirm({
				...
				message: this.$t(
					"CasaOS dashboard will get the the latest news feed of https://blog.vionetaos.io via Internet, which might leave your visit records to the site. Do you accept?"
				),
				type: "is-dark",
