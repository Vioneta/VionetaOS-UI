...
-->
<template>
	<div :class="{ 'is-floating': isFloat }" :style="positionStyle" class="drop-button">
		<b-dropdown ref="drop" :mobile-modal="false" :position="tipPosition" :style="cssVariables" class="drop-tips">
			<template #trigger>
